...
public class SequecialxBinaria {		
	...
	public static void main(String[] args) {
		...
		System.out.println("Número de comparações para buscar qualquer chave na busca sequencial: " + maior);
		...
		System.out.println("Número de comparações para buscar qualquer chave na busca binária: " + maior);
